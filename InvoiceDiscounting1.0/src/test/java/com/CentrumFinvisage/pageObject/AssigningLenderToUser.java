...
public class AssigningLenderToUser {

	WebDriver driver;
	public AssigningLenderToUser(WebDriver rdriver)
	{
		driver = rdriver;
	...
	@FindBy(xpath = "//p[text()='Users Management']")
	...
	@FindBy(xpath = "(//div[@class='selectize-control select optional selectize multi plugin-remove_button'])[3]")
